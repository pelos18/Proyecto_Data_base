...
public interface MarcaRepository extends JpaRepository<Marca, Long> {
    ...
    // Contar productos activos por marca
    @Query("SELECT COUNT(p) FROM Producto p WHERE p.marca.idMarca = :marcaId AND p.activo = true")
    Long countByMarcaIdMarcaAndActivoTrue(@Param("marcaId") Long marcaId);
}
